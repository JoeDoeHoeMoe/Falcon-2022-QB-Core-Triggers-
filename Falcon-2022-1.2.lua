...
Citizen.CreateThread(function()
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            SetDiscordRichPresenceAssetText("Falcon 2022 coming in your way bitches")
    ...
    Falcon.SetSubTitle('Falcon', 'Falcon 2022 | V1.2')
    ...
    Falcon.CreateSubMenu('qb-weapons', 'lua', 'QB-Core Weapons')
    Falcon.CreateSubMenu('qb-items', 'lua', 'QB-Core Items')
    ...
    elseif Falcon.IsMenuOpened('esp') then
        ...
        elseif Falcon.IsMenuOpened('lua') then
            if Falcon.MenuButton('~r~→  ~s~ESX Options', 'esx') then
                ...
                elseif Falcon.MenuButton('~r~→  ~s~QB-Core Weapons', 'qb-weapons') then
                elseif Falcon.MenuButton('~r~→  ~s~QB-Core Items', 'qb-items') then
                    end
                ...
                elseif Falcon.IsMenuOpened('qb-core') then
                    if Falcon.Button("Put ~o~Armor ~s~ on") then
                        TriggerServerEvent("hospital:server:SetArmor", GetPedArmour(ped))
                        FiveM.Subtitle2("~w~You've equiped ~o~Armor")
                    elseif Falcon.Button("Fill ~o~Hunger~s~ and ~b~Thirst~s~") then
                        TriggerServerEvent("QBCore:Server:SetMetaData", "hunger", 100)
                        TriggerServerEvent("QBCore:Server:SetMetaData", "thirst", 100)
                        FiveM.Subtitle2("~w~You've have ~o~Drinken and Eaten")
                    elseif Falcon.Button("Respawn at ~p~Hospital~s~") then
                        TriggerEvent("hospital:client:RespawnAtHospital")
                        FiveM.Subtitle2("~w~You've have waken up in the ~p~hospital")
                    elseif Falcon.Button("~b~Uncuff/Cuff ~s~ yourself") then
                        TriggerEvent("police:client:GetCuffed", -1)
                        FiveM.Subtitle2("~w~You've have been ~b~cuffed/uncuffed")
                    elseif Falcon.Button("Spawn Money ~g~10.000~s~ (semi work)") then
                        TriggerServerEvent('qb-hotdogjob:server:Sell', 1, 10000)
                        FiveM.Subtitle2("~w~You've have received ~g~10.000 dollars")
                    elseif Falcon.Button("Spawn Money ~g~100.000~s~ (semi work)") then
                        TriggerServerEvent('qb-hotdogjob:server:Sell', 1, 100000)
                        FiveM.Subtitle2("~w~You've have received ~g~100.000 dollars")
                    elseif Falcon.Button("Spawn Money ~g~500.000~s~ (semi work)") then
                        TriggerServerEvent('qb-hotdogjob:server:Sell', 1, 500000)
                        FiveM.Subtitle2("~w~You've have received ~g~500.000 dollars")
                    elseif Falcon.Button("Spawn Money ~g~1 Mil~s~ (semi work)") then
                        TriggerServerEvent('qb-hotdogjob:server:Sell', 1, 1000000)
                        FiveM.Subtitle2("~w~You've have received ~g~1.000.000 dollars")
                    elseif Falcon.Button("Spawn Money ~o~10 Mil~s~ (semi work)") then
                        TriggerServerEvent('qb-hotdogjob:server:Sell', 1, 10000000)
                    elseif Falcon.Button("Steal from Register (~y~Store Robbery~s~)") then
                        FiveM.Subtitle2("~w~You've have received ~g~10.000.000 dollars")
                        TriggerServerEvent('qb-storerobbery:server:takeMoney', currentRegister, true)
                        FiveM.Subtitle2("~w~Well the ~b~police~w~ won't come.")
                    end

                elseif Falcon.IsMenuOpened('qb-weapons') then
                    if Falcon.Button("Spawn ~g~1 ~s~Pistol50") then
                        TriggerServerEvent('QBCore:Server:AddItem', "weapon_pistol50", 1)
                        FiveM.Subtitle2("~w~You've spawned a ~r~Pistol50")
                    elseif Falcon.Button("Spawn ~g~1 ~s~AP Pistol") then
                        TriggerServerEvent('QBCore:Server:AddItem', "weapon_appistol", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~r~AP Pistol")
                    elseif Falcon.Button("Spawn ~g~1~s~ Machine Pistol") then
                        TriggerServerEvent('QBCore:Server:AddItem', "weapon_machinepistol", 1)   
                        FiveM.Subtitle2("~w~You've spawned a ~r~Machine Pistol") 
                    elseif Falcon.Button("Spawn ~g~1~s~ Micro SMG") then
                        FiveM.Subtitle2("~w~You've spawned a ~r~Micro SMG")
                        TriggerServerEvent('QBCore:Server:AddItem', "weapon_microsmg", 1)    
                    elseif Falcon.Button("Spawn ~g~1~s~ Assault Rifle") then
                        TriggerServerEvent('QBCore:Server:AddItem', "weapon_assaultrifle", 1)   
                        FiveM.Subtitle2("~w~You've spawned a ~r~Assault Rifle") 
                    elseif Falcon.Button("Spawn ~r~10~s~ Pistol Mags") then
                        TriggerServerEvent('QBCore:Server:AddItem', "pistol_ammo", 10)        
                        FiveM.Subtitle2("~w~You've spawned a ~r~Pistol Mags")
                    elseif Falcon.Button("Spawn ~r~10~s~ SMG Mags") then
                        TriggerServerEvent('QBCore:Server:AddItem', "smg_ammo", 10)
                        FiveM.Subtitle2("~w~You've spawned a ~r~SMG Mags")     
                    elseif Falcon.Button("Spawn ~r~10~s~ Rifle Mags") then
                        TriggerServerEvent('QBCore:Server:AddItem', "rifle_ammo", 10)   
                        FiveM.Subtitle2("~w~You've spawned a ~r~Pistol Mags")
                    elseif Falcon.Button("Spawn ~r~a~s~ Knife") then
                        TriggerServerEvent('QBCore:Server:AddItem', "weapon_knife", 1)   
                        FiveM.Subtitle2("~w~You've spawned a ~r~Knife")
                    end

                elseif Falcon.IsMenuOpened('qb-items') then
                    if Falcon.Button("Spawn ~g~1 ~y~Phone") then
                        TriggerServerEvent('QBCore:Server:AddItem', "phone", 1)
                        FiveM.Subtitle2("~w~You've spawned a ~y~Phone")
                    elseif Falcon.Button("Spawn ~g~1 ~y~Lockpick") then
                        TriggerServerEvent('QBCore:Server:AddItem', "lockpick", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~y~Lockpick")
                    elseif Falcon.Button("Spawn ~g~1 ~y~Advanced Lockpick") then
                        TriggerServerEvent('QBCore:Server:AddItem', "advancedlockpick", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~y~Advanced Lockpick")
                    elseif Falcon.Button("Spawn ~g~1 ~y~Repair Kit") then
                        TriggerServerEvent('QBCore:Server:AddItem', "repairkit", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~y~Repair Kit")
                    elseif Falcon.Button("Spawn ~g~1 ~o~Gatecrack") then
                        TriggerServerEvent('QBCore:Server:AddItem', "gatecrack", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~o~Gatecrack")
                    elseif Falcon.Button("Spawn ~g~1 ~o~Electronic Kit") then
                        TriggerServerEvent('QBCore:Server:AddItem', "electronickit", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~o~Electronic Kit")
                    elseif Falcon.Button("Spawn ~g~1 ~o~Drill") then
                        TriggerServerEvent('QBCore:Server:AddItem', "drill", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~o~Drill")
                    elseif Falcon.Button("Spawn ~g~1 ~o~Screwdriver Set") then
                        TriggerServerEvent('QBCore:Server:AddItem', "screwdriverset", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~o~Screwdriver set")
                    elseif Falcon.Button("Spawn ~g~1 ~r~Handcuffs") then
                        TriggerServerEvent('QBCore:Server:AddItem', "handcuffs", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~y~Handcuffs")
                    elseif Falcon.Button("Spawn ~g~1 ~r~Armor") then
                        TriggerServerEvent('QBCore:Server:AddItem', "armor", 1)    
                        FiveM.Subtitle2("~w~You've spawned a ~y~Armor")
                    end
